  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axiosInstance.post('/users', {
        ...
        role: USER_ROLES.USER, // Always create with USER role
      })
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.username && <InlineErrorMessage error={errors.username} />}
                  </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      />
                      {errors.password && <InlineErrorMessage error={errors.password} />}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      {errors.confirmPassword && <InlineErrorMessage error={errors.confirmPassword} />}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-md">
                  <p className="text-sm text-blue-800 dark:text-blue-200">
                    <strong>Note:</strong> New users will be created with "User" role (role: 2) by default. 
