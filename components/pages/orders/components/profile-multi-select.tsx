...
export function ProfileMultiSelect({ value, onChange, onProfilesLoad }: ProfileMultiSelectProps) {
  ...
  const loadProfiles = useCallback(async (pageNum: number, searchTerm: string, reset = false) => {
    ...
    try {
      ...
      if (res.success && res.data) {
        const newProfiles = reset ? res.data.profiles : [...profiles, ...res.data.profiles];
  ...
  }, [loading, profiles, onProfilesLoad]);
